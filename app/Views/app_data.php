...
*/
	...
	<body class="todo" style="font-family: Mochiy Pop P One">
		...
		<figure class="snip1336">
  			...
  			<figcaption>
				<img src="../Resources/pictures/manuPerfil.jpg" alt="profile-sample4" class="profile" />
				<br>
				<br>
				<br>
				<br>
				<h2>Manuel Antonio Reino Diez</h2>
				<h2><span class="datosPerfil">Vocalista</span></h2>
				<h2><span class="datosPerfil">+34 608210200</span></h2>
				<h2><span class="datosPerfil">manu1993reino@gmail.com</span></h2>
				<p>Soy cantante en un grupo llamado Eruktogatos, me gusta el rock y la programación, gracias a Easy Rock se me esta 
					haciendo muy facil algo que antes era tan complicado como cuadrarme con todo mi grupo para poder disfrutar
					de unajornada de ensayos.
				</p>
				<a href="../Models/login.php" class="cerrarSesion">Cerrar Sesión</a>
				<a href="../Views/app_reserva.php" class="reservas">Reservas</a>
  			</figcaption>
		</figure>
		<br>
		<br>
