...
*/
	...
	<body style="font-family: Mochiy Pop P One">
		<div id="panel_menu">
            ...
            <span>Datos personales &nbsp;&nbsp;&nbsp;&nbsp;<img src="../Resources/pictures/icon-perfil-personal.png"></span>
        ...
        <div class="divprincipal">
            <div class="divsecundario">
                <h2>&nbsp;Nombre: <?php ?></h2>
                <h2>&nbsp;Apellidos: <?php ?></h2>
                <h2>&nbsp;Fecha de nacimiento: <?php ?></h2>
                <h2>&nbsp;Código de usuario: <?php ?></h2>
                <h2>&nbsp;Saldo actual: <?php ?></h2>
